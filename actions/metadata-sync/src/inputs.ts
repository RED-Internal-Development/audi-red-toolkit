...
export function readMetadataSyncInputs(): MetadataSyncInputs {
  const parsed = parseMetadataSyncInputsFromRecord({
...
export function parseMetadataSyncInputsFromRecord(
  inputs: InputRecord,
): MetadataSyncInputs {
