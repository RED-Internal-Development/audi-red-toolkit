...
import { readReportSyncInputs } from "./inputs.js";
import { executeReportSync } from "./sync.js";

export async function run(): Promise<void> {
  const inputs = readReportSyncInputs();
  const result = await executeReportSync(inputs);
