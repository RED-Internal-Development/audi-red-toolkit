...
export function readCollectionSyncInputs(): CollectionSyncInputs {
  const parsed = parseCollectionSyncInputsFromRecord({
...
export function parseCollectionSyncInputsFromRecord(
  inputs: InputRecord,
